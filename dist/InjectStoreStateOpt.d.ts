...
export interface IPropsInjectStoreStateOpt<S extends object = any, P extends TAllPathsParameter<S> = TAllPathsParameter<S>, O extends [
...
export declare function InjectStoreStateOpt<S extends object, P extends TAllPathsParameter<S>, O extends [
    DeepTypeOfArray<S, P[0]>,
    DeepTypeOfArray<S, P[1]>,
    DeepTypeOfArray<S, P[2]>,
    DeepTypeOfArray<S, P[3]>,
